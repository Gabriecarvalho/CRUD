...
public class HistoricoPesoGUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form HistoricoPeso
     */
    ...
    private void initComponents() {
        ...
        jButton1.setText("Cadastrar Peso");
        ...
        jButton2.setText("Excluir Historico");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String[] dados = AlunoDAO.consulta(cpf); //consultando para pegar o nome e verificar se existe
                     
        HistoricoPesoDAO HistoricoPesoDAO = new HistoricoPesoDAO();
                              
       if (jTextField1.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Insira um cpf para remover historico");
            return;
        }else if (dados[4].equals("")){
            JOptionPane.showMessageDialog(null, "Esse cpf não consta no banco de dados");
            jTextField1.setText("");
        }else{
            HistoricoPesoDAO.remove(cpf);
            CalculadoraIMC.removerResultado(cpf);
            JOptionPane.showMessageDialog(null, "Historico Removido com sucesso");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String texto = jTextField2.getText();  //bloco para pegar dados ou manipular eles
        String cpf = jTextField1.getText();
        String[] dados = AlunoDAO.consulta(cpf); //consultando para pegar o nome e verificar se existe
        ...
        String nome = dados[0];
        HistoricoPeso HistoricoPeso = new HistoricoPeso(cpf,dataSQL,peso,nome);
        HistoricoPesoDAO HistoricoPesoDAO = new HistoricoPesoDAO();
        Aluno.setPeso(peso);
        Aluno.setNome(nome);
        Aluno.setCpf(cpf);
